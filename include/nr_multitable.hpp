...
template <typename Vect> class NR_MultiTable {
private:
...
public:
  NR_MultiTable(int64_t num_tables, int64_t num_partitions, int64_t bits,
                int64_t dim)
  ...
  template <typename Cont> void fill(const Cont &data) {
